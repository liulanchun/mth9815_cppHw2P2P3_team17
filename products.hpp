 ...
 */
enum FutureType { EURODOLLARFTR, BONDFTR, OILFTR };

class Future : public Product
{
public:
  // Future ctor
  Future(string _productId, FutureType _futureType, date _maturityDate, float _settleprice);
  Future();
...
{
public:
	EuroDollarFuture(string _productId, date _maturityDate, float _settleprice);
};
class BondFuture : public Future
{
public:
	BondFuture(string _productId, date _maturityDate, float _settleprice);
};


/*implementation of future*/
Future::Future(string _productId, FutureType _futureType, date _maturityDate, float _settleprice) : Product(_productId, FUTURE)
{
